    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="home.php"><i class="fa-solid fa-house"></i>&nbsp; Inicio <span
        ...
        <ul class="navbar-nav align-items-center">
            ...
            <!-- Notificaciones -->
            <a class="nav-link" href="notificaciones.php"> <i class="fa-solid fa-bell"></i>&nbsp; Notificaciones</a>
            <!-- Usuario -->
